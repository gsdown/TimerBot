...
namespace TimerBot
{
    ...
    {
        // ReconnectInitialDelay: This needs to be longer than how long it usually takes the bot to automatically reconnect
        private static readonly TimeSpan ReconnectInitialDelay = TimeSpan.FromSeconds(5);
        private static readonly TimeSpan ReconnectDelay = TimeSpan.FromSeconds(3); // Delay between attempts
        private static readonly TimeSpan ReconnectTimeout = TimeSpan.FromSeconds(20); // How long to wait for an attempt to reconnect
